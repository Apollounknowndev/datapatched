...
public record AddPools(CommonModifierData commonData, List<LootPool> pools) implements LootModifier {
    public static final MapCodec<AddPools> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
        CommonModifierData.codec(1000).forGetter(AddPools::commonData),
