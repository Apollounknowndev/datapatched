...
public record AddEntries(CommonModifierData commonData, List<LootPoolEntryContainer> entries) implements LootModifier {
    public static final MapCodec<AddEntries> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
        CommonModifierData.codec(0).forGetter(AddEntries::commonData),
