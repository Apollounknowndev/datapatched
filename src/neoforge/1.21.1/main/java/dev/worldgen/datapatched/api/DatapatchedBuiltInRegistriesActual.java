...
public class DatapatchedBuiltInRegistriesActual {
    @Actual public static final Registry<MapCodec<? extends LootModifier>> LOOT_MODIFIER_TYPE = DatapatchedEntrypoint.DEFERRED_LOOT_MODIFIER_TYPES.makeRegistry(b -> {});
}
